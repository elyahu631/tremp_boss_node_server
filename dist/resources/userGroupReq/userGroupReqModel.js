...
class UserGroupReqModel {
    constructor(userGroupReqData) {
        ...
        this.status = userGroupReqData.status || 'pending';
    }
    validateTremp() {
        const schema = joi_1.default.object({
            ...
            status: joi_1.default.string().valid('approved', 'pending', 'denied').default('pending'),
        });
...
exports.default = UserGroupReqModel;
//# sourceMappingURL=userGroupReqModel.js.map