...
kpiRoutes.get('/get-top-routes', auth_1.authenticateAdminToken, KpiController.getMostPopularRoutes);
kpiRoutes.get('/get-top-drivers', auth_1.authenticateAdminToken, KpiController.getTopDrivers);
kpiRoutes.get('/get-top-hours', auth_1.authenticateAdminToken, KpiController.getMostRequestedHours);
